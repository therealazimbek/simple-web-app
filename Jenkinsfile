pipeline {
    ...
    stages {
        ...
        stage('Deploy to Tomcat') {
            steps {
                deploy adapters: [tomcat9(credentialsId: '428bc5a1-e411-4f20-aa19-da5afdfb78a8', path: 'http://localhost:8000/manager/html', url: 'http://localhost:8000')], contextPath: null, onFailure: false, war: '**/*.war'
            }
        }
    }
}
